...
object MyDBVendor extends ConnectionManager {
  ...
  private lazy val chooseURL = Props.mode match {
    case Props.RunModes.Production => "jdbc:mysql://localhost:3306/scala-china"
    case _                         => "jdbc:mysql://localhost:3306/scala-china"
  }
  ...
  private def createOne: Box[Connection] = try {
    ...
    val dm = (Props.get("mysql.db.user"), Props.get("mysql.db.password")) match {
